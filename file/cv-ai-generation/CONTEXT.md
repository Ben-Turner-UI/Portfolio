...
- Ben has authorized some claims that are not on the homepage (Hyperoptic, five hires, agency growth, Perforce new customers, CityFibre ~2,000 people, whole-product ownership at Budibase, AI-enabled features, helped design and test a Perforce design system of written components + MCP + Claude plugin for generated UI but did **not** build or own that system or plugin, Claude systems he built won Best Designed at the company AI hackathon in 2026, Budibase air-gapped/self-hosted secure environments, Perforce interfaces holding secure enterprise data, SportsWork now an independent profitable startup, public sector / private / corporate clients at DawsonAndrews, PSNI / defence / legal and law). Do not put PSNI on the CV unless he asks. Do not add more unpublished metrics unless he asks.
