...
- Experience jobs need a clear gap between companies (**22px** between roles). **More experience on linkedin.com/in/benturnerwork** sits left-aligned between Experience and Skills (extra vertical margin). PSNI and other earlier roles are not on the public CV; point readers to LinkedIn. Education then Hobbies, **single column** (two-column split interleaves in ATS). Dates use **Present**, not today.
...
- Mentoring lives in the DawsonAndrews experience: "I mentored multiple designers throughout my time at the agency." Do not put "at least 10 designers" back on the public CV unless he asks. Skills include Typography, Visual hierarchy, Micro-interactions for visual craft.
...
- Ben has authorized some claims that are not on the homepage (Hyperoptic, five hires, agency growth (CityFibre homepage success helped DawsonAndrews grow from small to medium-sized), Perforce new customers, CityFibre ~2,000 people, whole-product ownership at Budibase, AI-enabled features, owns sections of the Perforce design system and Claude skills around context building and generative AI workflows, not the whole system or the Claude plugin, Claude systems he built won Best Designed at the company AI hackathon in 2026, mentored multiple designers throughout his time at DawsonAndrews (public CV, 2026-09-25; "at least 10" stays off the public CV unless he asks), Budibase air-gapped/self-hosted secure environments, Perforce interfaces holding secure enterprise data, SportsWork now an independent profitable startup, public sector / private / corporate clients at DawsonAndrews, one of the lead designers at the PSNI). Ben removed the PSNI summary sentence from the public CV on 2026-09-25. Do not put it back unless he asks. On 2026-09-25 the public summary is one paragraph with seven years of experience (enterprise, startup, agency; sales and scale; team culture). Do not restore the three labelled summary bullets, the How I work line, or the Read more link unless he asks. The CityFibre 90% and doubled-satisfaction bullet is not in the public experience section; the CityFibre case tag stays. Do not put that metrics bullet back unless he asks. Public Perforce line (2026-09-25): production front-end via Claude Code to bridge a 66% drop in engineering capacity, feature output up 25% (same story as six developers to two). Do not add more unpublished metrics unless he asks.
