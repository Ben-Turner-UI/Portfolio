...
- Contact sits **under the name**, full width, plaintext: site, `+44` phone, email, `linkedin.com/in/benturnerwork`, Carrickfergus, Northern Ireland. No icon font (icons extract as `?` in ATS). Underline link labels only. **More experience on linkedin.com/in/benturnerwork** sits between Experience / DawsonAndrews and Skills.
