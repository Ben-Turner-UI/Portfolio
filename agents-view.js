(function () {
  ...
  function markdownSource() {
    ...
    return [
      ...
      '',
      'Open to senior product design roles. Remote-first, about one day a week in an office.',
      '',
      'This page is a copyable summary of the portfolio for AI agents. The designed site is one toggle away.',
      '',
      '## Pages',
      '',
      ...
      '',
      'Product Designer. Carrickfergus, Northern Ireland. Open to senior product design roles. Remote-first, about one day a week in an office.',
      '',
      '### Experience',
      '',
      ...
      '## Selected work',
      '',
      '### [P4 DAM: shipping after the cuts](' + dam + ')',
      ...
      '',
      '### [Budibase Automations](' + automations + ')',
