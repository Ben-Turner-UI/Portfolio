(function () {
  ...
  function markdownSource() {
    ...
    return [
      ...
      '',
      'Homepage case studies (in order): Development team cut in half (P4 DAM production), Increasing sales opportunities (personas / generative AI), Leading P4 DAM product design, Budibase feature showcase, Budibase Automations, CityFibre rebrand.',
      '',
      ...
      '',
      '### [Our development team was cut in half, I ensured that features were delivered on time with excellent design using modern AI tools and workflows](' + dam + ')',
      'Perforce · P4 DAM · 2025–2026',
      '',
      'Tags on homepage: Claude Code, Design system, DesignOps.',
      '',
      'Front-end capacity on P4 DAM dropped from six developers to two. With Claude Code and the workflows Ben designed around generative AI, the team still released 25% more features per quarter than the same quarter the year before (before he joined). That number comes from the PM; quality held.',
      '',
      ...
      '',
      'Note on the page: images are not available; the feature is unreleased and some data is confidential. Text-only case study.',
      '',
      'Business shifted toward new customers / acquisitions in the AI era. Onboarding was the weak point and where the sales pipeline starts. Old personas were outdated and described users, not the buyer. The buyer is a studio manager.',
      '',
      ...
      '',
      '### [How I lead product design to fix many key user flow issues that other designers and developers did not catch before](' + product + ')',
      'Perforce · Product ownership · 2025',
      '',
      'Tags on homepage: Claude Code, Search, Navigation.',
      '',
      'P4 DAM sits on Perforce version control. Studios such as Electronic Arts, Meta, Xbox Game Studios, and Pinewood store huge libraries of 3D models, textures, and media. Ben led product design on core areas from the ground up: search history, advanced filtering, breadcrumbs, asset preview, and the dashboard. He caught and fixed key user-flow issues that other designers and developers had missed.',
      '',
      ...
      '',
      '### [Budibase feature showcase: branches, permissions, and in-app calculations](' + bbui + ')',
      'Budibase · 2024–2025',
      '',
      'Tags on homepage: Low-code, Permissions, Automations.',
      '',
      'While Ben owned product design for Budibase, he shipped UI for automation branches, role-based access, and calculated fields so admins could build secure apps without leaving the builder.',
      '',
      ...
      '',
      'Budibase is open-source low-code for custom apps (portals, admin panels, internal tools), self-hosted so data stays on customer infrastructure. End-to-end redesign of the visual automation / workflow builder. Old builder hid data in and out of each step, so debugging was guesswork.',
      '',
      ...
      '',
      '### [Driving a 90% conversion boost: The CityFibre digital rebrand](' + cityfibre + ')',
      'DawsonAndrews · CityFibre · 2021–2024',
      '',
      'Tags on homepage: Rebrand, Design system, Conversion.',
      '',
      'Lead designer on the CityFibre account (UK\'s second-largest fibre broadband infrastructure provider). Owned the digital rebrand: marketing website, backend portal, campaign landing pages, company emails, and other digital touchpoints. Updated the Figma design system to the new brand guidelines, held AA accessibility on a neon-heavy palette, and improved UX on journeys including the postcode availability checker. Goal: contemporary, inclusive challenger brand vs Virgin Media and BT.',
      '',
      ...
      '',
      '### [Olympus](' + olympus + ')',
      'A wearable brand Ben created: five premium watch faces for Facer, built for battery life and outdoor readability, plus a Creator\'s Toolkit with 3D mockups.',
      '',
      '### [Remastering a 2008 EA strategy game for 2026](' + kane + ')',
      'Fan remaster of Command & Conquer 3: Kane\'s Wrath from 2008-era assets to today\'s 4K standards, using AI to rebuild units, structures, and shaders at scale. Still plays in C&C Online multiplayer, including ranked maps. Ben helped patch, test, and release it.',
      '',
      '---',
      '',
      '## About',
