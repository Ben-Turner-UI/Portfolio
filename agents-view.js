(function () {
  ...
  function markdownSource() {
    ...
    return [
      ...
      '',
      'Homepage case studies (in order): Shipping production code (P4 DAM), Increasing sales opportunities (personas / generative AI), Owning P4 DAM, Budibase Automations, CityFibre rebrand.',
      '',
      ...
      '',
      'P4 DAM sits on Perforce version control. Studios such as Electronic Arts, Meta, Xbox Game Studios, and Pinewood store huge libraries of 3D models, textures, and media. Ben owned direction of core areas from the ground up: search history, advanced filtering, breadcrumbs, asset preview, and the dashboard. Core idea: get people to the asset, then let them manage it.',
      '',
      ...
      '',
      'Lead designer on the CityFibre account (UK\'s second-largest fibre broadband infrastructure provider). Brand guidelines were given; Ben did not define them. Implemented across marketing website, backend portal, campaign landing pages, company emails, and other digital touchpoints. Rebuilt the Figma design system. Held AA accessibility on a neon-heavy palette. Goal: contemporary, inclusive challenger brand vs Virgin Media and BT.',
      '',
      '90% more people clicked Check availability than at the same point three months earlier (measured on the homepage). The agency used that result with prospective clients and to win Hyperoptic. Related CV claim: that success helped DawsonAndrews grow from a small to a medium-sized agency.',
      '',
      '---',
      '',
